  ...
  const renderAnalysis = () => {
    ...
    return (
      <div className="animate-in slide-in-from-right duration-500">
        <div className="bg-white sticky top-0 z-10 p-4 pt-[calc(env(safe-area-inset-top,24px)+1rem)] shadow-sm border-b border-gray-100 flex items-center justify-between">
